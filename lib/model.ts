...
export type Person = { id: string; name: string; color: string; email?: string | null; phone?: string | null; monthlyLimitCents?: number; accountId?: string | null; version?: number };
