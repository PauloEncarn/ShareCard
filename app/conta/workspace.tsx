...
export default function CloudWorkspace() {
  ...
  async function authenticate(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const result = await api<{account: Account}>('login', json(payload)); setAccount(result.account); await refresh(result.account); if (result.account.role === 'master') window.location.assign('/organizador');
